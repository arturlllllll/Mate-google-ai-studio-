...
const StatIcon: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div className="flex w-[64px] h-[64px] md:w-[88px] md:h-[88px] p-[8px] flex-col justify-center items-center gap-[8px] rounded-[16px] bg-[#2A2F3C] flex-shrink-0">
    {children}
  </div>
);
...
export const Hero: React.FC = () => {
  return (
    <section 
      className="pt-[100px] md:pt-[110px] pb-[40px] px-4 md:px-12 bg-no-repeat bg-cover bg-center relative overflow-hidden"
    ...
    >
      <div className="max-w-[1408px] mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row items-center text-center lg:text-left justify-between mb-[40px]">
          <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start gap-6">
            ...
            <div className="space-y-4">
              ...
              <p className="text-subtitle max-w-[440px] mx-auto lg:mx-0">
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-end mt-8 lg:mt-0 relative">
            <img 
              ...
              className="w-full max-w-[540px] h-auto object-contain relative z-[-1] translate-y-[20px] md:translate-y-[40px]"
            />
          </div>
        </div>

        {/* Stats Blocks Container */}
        <div className="flex flex-col xl:flex-row gap-[16px] md:gap-[32px] items-stretch relative z-20 mt-[-40px] md:mt-[-100px]">
          
          {/* Black Section */}
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-[16px] md:gap-[32px] p-[24px] md:p-[32px] items-center rounded-[24px] md:rounded-[32px] bg-[#212631] shadow-2xl">
            {/* Item 1 */}
            <div className="flex items-center gap-[16px] md:gap-[24px]">
              ...
              <p className="text-white text-[14px] md:text-[16px] font-medium leading-[1.4]">
                Місія — допомогти кожному побудувати кар’єру в ІТ
              </p>
            </div>
            ...
            <div className="flex items-center gap-[16px] md:gap-[24px]">
              ...
              <p className="text-white text-[14px] md:text-[16px] font-medium leading-[1.4]">
                Нагорода «Rising Star» від Google for Startups
              </p>
            </div>
            ...
            <div className="flex items-center gap-[16px] md:gap-[24px]">
              ...
              <p className="text-white text-[14px] md:text-[16px] font-medium leading-[1.4]">
                Навчаємо у Польщі та Бразилії з 2022
              </p>
            </div>
            ...
            <div className="flex items-center gap-[16px] md:gap-[24px]">
              ...
              <p className="text-white text-[14px] md:text-[16px] font-medium leading-[1.4]">
                Працевлаштовуємо айтівців понад 11 років
              </p>
            </div>
          </div>

          {/* Purple Section */}
          <div className="w-full xl:w-[392px] p-[24px] md:p-[32px] flex flex-col items-center xl:items-start gap-[24px] md:gap-[32px] rounded-[24px] md:rounded-[32px] bg-[#5955F4] shadow-2xl">
            <div className="flex flex-col items-center xl:items-start gap-[12px]">
              ...
              <p className="text-white text-[13px] md:text-[14px] font-semibold text-center xl:text-left">
                4,300+ мейтівців вже працюють в ІТ
              </p>
            </div>

            <h2 className="text-white text-[48px] md:text-[80px] font-extrabold leading-[1] tracking-[-2px] md:tracking-[-4px]">
              90%
            </h2>

            <p className="text-white text-[14px] md:text-[16px] font-medium text-center xl:text-left">
